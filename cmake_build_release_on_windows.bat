...
cmake .. -G "Visual Studio 17 2022" -DCMAKE_BUILD_TYPE=Release -DWITH_JDBC=ON -DWITH_SSL="%OPENSSL_ROOT_DIR%" -DCMAKE_INSTALL_PREFIX=%project_base_dir%/out -DINSTALL_LIB_DIR=%project_base_dir%/out/lib
