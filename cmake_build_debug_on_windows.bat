...
cmake .. -G "Visual Studio 17 2022" -DCMAKE_BUILD_TYPE=Debug -DWITH_JDBC=ON -DCMAKE_INSTALL_PREFIX=%project_base_dir%/out -DINSTALL_LIB_DIR=%project_base_dir%/out/lib
